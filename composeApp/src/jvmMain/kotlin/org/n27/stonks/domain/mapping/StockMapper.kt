...
internal fun mapToStock(
    ...
    computed = Computed(
        ...
        payoutRatio = computePayoutRatio(price, dividendYield, incomeStatement?.eps),
...
private fun computePayoutRatio(price: Double?, dividendYield: Double?, eps: Double?): Double? {
    if (price == null || dividendYield == null || eps == null || eps == 0.0) return null
    return ((dividendYield / 100) * price / eps) * 100
}
